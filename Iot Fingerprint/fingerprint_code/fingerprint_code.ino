...
//const char *ssid = "fmgold";  //ENTER YOUR WIFI SETTINGS
//const char *password = "whyareyouaskingme??";

const char *ssid = "riel";  //ENTER YOUR WIFI SETTINGS
const char *password = "12345678";
//************************************************************************
String postData ; // post array that will be send to the website
String Link = "http://192.168.131.67/biometricattendance/getdata.php"; //computer IP or the server domain
//String Link = "https://votein-server.herokuapp.com/api/biometrics"; //computer IP or the server domain
